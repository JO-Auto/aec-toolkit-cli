def calculate_required_tank_volume(number_of_people, consumption_per_person_per_day, storage_days):
    daily_water_demand = number_of_people * consumption_per_person_per_day
    ...
    while True:
        ...
        while True:
            try:
                ...
                consumption_per_person_per_day = float(
                    input("Daily consumption per person (L/person/day): "))
                storage_days = float(input("Storage duration: "))

                if number_of_people <= 0 or consumption_per_person_per_day <= 0 or storage_days <= 0:
                    print("Invalid input")
                    continue
            ...
            required_tank_volume, cubic_meters = calculate_required_tank_volume(number_of_people,
                                                                                consumption_per_person_per_day,
                                                                                storage_days)
